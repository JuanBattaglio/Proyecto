...
async function seedDatabase() {
    try {
        ...
        const users = await User.insertMany([
            { email: 'maria@ejemplo.com', name: 'María', age: 28, city: 'Madrid', interestedEvents: ['1985454109689'] },
            { email: 'juan@ejemplo.com', name: 'Juan', age: 35, city: 'Barcelona', interestedEvents: ['1985454109689'] },
            { email: 'lucia@ejemplo.com', name: 'Lucía', age: 22, city: 'Valencia', interestedEvents: ['1985454109689'] }
        ]);
